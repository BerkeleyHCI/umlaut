...
class OverfittingError(BaseErrorMessage):
    ...
    description = 'Your validation loss is increasing while your training loss is stuck or decreasing. This could indicate overfitting.' \
                  '\n####Solution' \
                  '\nTry reducing the power of your model or adding regularlization.'
